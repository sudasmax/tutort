...
namespace Tutort.Web.Helpers
{
    public static class CultureExtensions
    {
        ...
        public static string GetImplementedCulture(string name)
        {
            ...
            if (string.IsNullOrEmpty(name) || !ValidCultures.Any(c => c.Equals(name, StringComparison.InvariantCultureIgnoreCase)))
            {
            ...
            var neutralCultureName = GetNeutralCulture(name);
            var neutralCulture = Cultures.FirstOrDefault(x => x.StartsWith(neutralCultureName));

            return neutralCulture ?? GetDefaultCulture();
        }
